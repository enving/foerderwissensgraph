...
- **Erledigt:**
    ...
    - Strukturierte Task-Verfolgung in `.opencode/tasks.json` eingeführt.
    - Dokumentation konsolidiert und auf Kleinschreibung umgestellt.
    - `PRD.md` und `next-steps.md` auf aktuellen Stand gebracht.
- **Nächster Schritt:** Fehlerbehebung im UI-Filter (Phase B).
