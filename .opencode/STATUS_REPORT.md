...
- **VectorStore:** Mock-Fallback implementiert für Robustheit ohne Container.

**Testing:**
- **Script:** `scripts/test_ui_comprehensive.py`
- **Scope:** Filter, Graph Interaction (Click/Hover), Zoom, Search.
- **Result:** **100% Pass** ✅ (Screenshots in `docs/test_artifacts/`).
...
**Critical Path:** Disable HyDE → Docker Optimize → Deploy
